           ...
           <?php
                ...
                foreach ($userData as $userIndex)
                {
                    echo "<tr>";
                        ...
                        echo "<td>";
                        print_r ($userIndex['items']); 
                        echo "</td>";
                    
                        echo "<td>";
                        print_r ($userIndex['clothes']); 
                        echo "</td>";                    
                        
                        echo "<td>";
                        print_r ($userIndex['weapons']); 
                        echo "</td>";
                        
                        echo "<td>";
                        print_r ($userIndex['position']); 
                        echo "</td>";
                    
                        echo "<td>";
                        print_r ($userIndex['cash']); 
                        echo "</td>";
                    
                        echo "<td>";
                        print_r ($userIndex['bank']); 
                        echo "</td>";
                    
                        echo "<td>";
                        print_r ($userIndex['bankaccount']); 
                        echo "</td>";
                    
                        echo "<td>";
                        print_r ($userIndex['pain']); 
                        echo "</td>";
                    
                        echo "<td>";
                        print_r ($userIndex['blood']); 
                        echo "</td>";
                    
                        echo "<td>";
                        print_r ($userIndex['unconscious']); 
                        echo "</td>";
                    
                        echo "<td>";
                        print_r ($userIndex['damage']); 
                        echo "</td>";
                    echo "</tr>";
                }
            ?>
