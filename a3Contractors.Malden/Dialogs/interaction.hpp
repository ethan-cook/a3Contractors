class interaction
{
	...
	class controls 
	{
		...
		class RscButton_1600: RscButton
		{
			...
			w = 0.114583 * safezoneW;
			h = 0.0329871 * safezoneH;
			action = [0] call a3C_Client_fnc_interactionAction;
		};
		class RscButton_1601: RscButton
		{
			...
			w = 0.114583 * safezoneW;
			h = 0.0329871 * safezoneH;
			action = [1] call a3C_Client_fnc_interactionAction;
		};
		class RscButton_1602: RscButton
		{
			...
			w = 0.114583 * safezoneW;
			h = 0.0329871 * safezoneH;
			action = [2] call a3C_Client_fnc_interactionAction;
		};
		class RscButton_1603: RscButton
		{
			...
			w = 0.114583 * safezoneW;
			h = 0.0329871 * safezoneH;
			action = [3] call a3C_Client_fnc_interactionAction;
		};
		class RscButton_1604: RscButton
		{
			...
			w = 0.114583 * safezoneW;
			h = 0.0329871 * safezoneH;
			action = [4] call a3C_Client_fnc_interactionAction;
		};
		class RscButton_1605: RscButton
		{
			...
			w = 0.114583 * safezoneW;
			h = 0.0329871 * safezoneH;
			action = [5] call a3C_Client_fnc_interactionAction;
		};
		class RscButton_1606: RscButton
		{
			...
			w = 0.114583 * safezoneW;
			h = 0.0329871 * safezoneH;
			action = [6] call a3C_Client_fnc_interactionAction;
		};
		class RscButton_1607: RscButton
		{
			...
			w = 0.114583 * safezoneW;
			h = 0.0329871 * safezoneH;
			action = [7] call a3C_Client_fnc_interactionAction;
		};
		class RscButton_1608: RscButton
		{
			...
			w = 0.114583 * safezoneW;
			h = 0.0329871 * safezoneH;
			action = [8] call a3C_Client_fnc_interactionAction;
		};
	};
};